<script>
    ...
    function handleSubmit() {
        ...
        // Store strategy in localStorage for now (will be replaced with proper state management)
...
<div class="container mx-auto p-4 max-w-4xl">
    <div class="mb-6 flex items-center justify-between">
        <h1 class="text-2xl font-bold text-light-text dark:text-dark-text">Create New Strategy</h1>
                ...
                <div class="form-group">
                    ...
                    <div class="flex items-center space-x-4">
                        <div class="flex items-center">
                            <input type="radio" id="status-inactive" name="status" value="inactive" checked class="mr-2">

...
>
    <svelte:fragment slot="title">
        <div class="flex items-center gap-3">
            <div class="p-1.5 bg-theme-500/10 rounded-lg">
            ...
            <div>
                <h3 class="text-lg font-medium text-light-text dark:text-dark-text">Widget Settings</h3>
                <p class="text-sm text-light-text-muted dark:text-dark-text-muted">{widgetType || 'Configure widget'}</p>
            </div>
        </div>
    </svelte:fragment>

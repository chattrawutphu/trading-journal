...
<<<<<<< HEAD
                            <div class="absolute right-0 mt-2 w-48 card overflow-hidden">
                                <div class="py-1">
                                    <button
                                        class="w-full text-left px-4 py-2 text-light-text dark:text-dark-text hover:bg-light-hover dark:hover:bg-dark-hover transition-colors duration-200"
                                        on:click={() => goto('/profile')}
                                    >
                                        Profile Settings
                                    </button>
                                    <button
                                        class="w-full text-left px-4 py-2 text-red-500 hover:bg-light-hover dark:hover:bg-dark-hover transition-colors duration-200"

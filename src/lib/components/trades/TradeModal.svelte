...
{#if show}
    ...
    >
        <div class="card w-full max-w-2xl mx-4 relative">
            <!-- Header -->
            <div
                class="px-8 py-4 border-b border-light-border dark:border-dark-border flex justify-between items-center sticky top-0 bg-light-card dark:bg-dark-card rounded-t-lg"
            >
                <h2
                ...
                <form on:submit|preventDefault={handleSubmit} class="space-y-6">
                            ...
                            />
                                ...
                                />
                                    <Button
                                        ...
                                        icon="<svg class='w-5 h-5' fill='none' stroke='currentColor' viewBox='0 0 24 24'><path stroke-linecap='round' stroke-linejoin='round' stroke-width='2' d='M9 7h6m0 10v-3m-3 3h.01M9 17h.01M9 14h.01M12 14h.01M15 11h.01M12 11h.01M9 11h.01M7 21h10a2 2 0 002-2V5a2 2 0 00-2-2H7a2 2 0 00-2 2v14a2 2 0 002 2'/></svg>"/>
                                </div>
                            <div class="col-span-full">
                                <Input
                                    label="Exit Reason"
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            >
                                <label
                                    class="flex flex-col items-center justify-center w-full h-32 border-2 border-dashed border-light-border dark:border-dark-border rounded-lg cursor-pointer bg-light-hover dark:bg-dark-hover hover:bg-light-card dark:hover:bg-dark-card transition-colors duration-200"
                                >
                                    <div
                                        class="flex flex-col items-center justify-center pt-5 pb-6"
                                    >
                                        <svg
                                            class="w-8 h-8 mb-3 text-light-text-muted dark:text-dark-text-muted"
                                            fill="none"
                                            stroke="currentColor"
                                            viewBox="0 0 24 24"
                                        >
                                        ...
                                        <p
                                            class="text-sm text-light-text-muted dark:text-dark-text-muted"
                                        >
            ...
            <!-- Footer with Buttons -->
            <div
                class="px-8 py-4 border-t border-light-border dark:border-dark-border flex justify-end gap-4 sticky bottom-0 bg-light-card dark:bg-dark-card rounded-b-lg"
            >
